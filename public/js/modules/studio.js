...
'37,.2);color:#c4b5fd;font-weight:700">＋</button>\n        <div style="flex:1"></div>\n        <!-- Align -->\n        <button id="rteLeft"   onclick="wbRteAlign(\'left\')"   title="Left"   style="border:1px solid #2a2e3c;border-radius:5px;padding:2px 5px;font-size:10px;cursor:pointer;background:var(--jm-primary,#7c3aed);color:#fff">≡←</button>\n        <button id="rteCenter" onclick="wbRteAlign(\'center\')" title="Center" style="border:1px solid #2a2e3c;border-radius:5px;padding:2px 5px;font-size:10px;cursor:poin',
...
' <div id="wbDocNoImg" style="padding:20px;color:#9098ac;font-size:13px">No document loaded yet.<br>Open an image or PDF from Insert → Doc ref.</div>\n        <button id="wbDocAddToBoard" onclick="wbDocAddToBoard()" style="display:none;margin-top:8px;border:1px solid var(--jm-primary,#7c3aed);border-radius:8px;padding:5px 14px;font-size:12px;cursor:pointer;background:#1d202b;color:#e8eaf0">⬇ Add to board</button>\n      </div>\n    </div>\n\n    <!-- Save to course modal -->\n    <div id="wbSaveCourseModal" style=',
