...
(function () {
  ...
  var MODELS = ['Wallet', 'Certificates', 'WidgetAdmin', 'Analytics', 'MyStudents', 'Downloads', 'Recordings', 'AttendanceReport', 'Gamification', 'AiKey'];
  var CONTROLLERS = ['Wallet'];
  var SCREENS = ['Help', 'WidgetAdmin', 'Wallet', 'Certificates', 'Analytics', 'MyStudents', 'Downloads', 'Recordings', 'AttendanceReport', 'Gamification', 'AiKey'];

  function inject(folder, names) {
    names.forEach(function (n) {
      var s = document.createElement('script');
      s.src = '/ui/' + folder + '/' + n + '.js?v=7';
  ...
  reg.src = '/ui/registry/screens.js?v=7';
  reg.async = false;
